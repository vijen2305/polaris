...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/berachain/polaris-geth v0.0.0-20231018211752-fe6dbacddc73
...
require github.com/rs/zerolog v1.30.0 // indirect

require github.com/prysmaticlabs/prysm/v4 v4.1.0
